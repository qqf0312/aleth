...
//  double blockFees = 15.0;
    ...
    med->setNodeid(web3.nodeInfo().id.hex());
    ...
    // if(*mediator.nodeArry == 0) {
    //     if(mediator.era_) mediator.era_->initECgroup((uint32_t){0}, (uint32_t){2}, v);
    //     mediator.sendingChunkRequest(0, dq, &Mediator::nodeChunkMapping);
    // }
