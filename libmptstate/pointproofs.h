 ...
 */
int32_t pointproofs_batch_commit_update(struct pointproofs_pp prover,
                                        struct pointproofs_commitment com,
                                        const size_t *changed_idx,
                                        const struct pointproofs_value *val_old,
                                        const struct pointproofs_value *val_new,
                                        size_t nvalues,
